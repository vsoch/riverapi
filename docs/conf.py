...
# -*- coding: utf-8 -*-
#
# riverapi documentation build configuration file, created by
...
project = "River API Python"
copyright = "2022, Vanessa Sochat"

from riverapi import version
...
texinfo_documents = [
    (
        "index",
        "riverapi",
        "River API Documentation",
        ["Vanessa Sochat"],
        "riverapi",
        "River API is a specification and client for river",
        "Miscellaneous",
    ),
]
